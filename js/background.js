...
let currentOmniboxQuery, defaultOmniboxSuggestion;
...
let removeCtxSnippetList, addCtxSnippetList;
  ...
  removeCtxSnippetList = function() {
    ...
    if (defaultEntryExists) {
      chrome.contextMenus.remove(
        SNIPPET_MAIN_ID,
        pk.checkRuntimeError("REMOVE-SMI")
      );
      defaultEntryExists = false;
    }
  };
...
chrome.runtime.onInstalled.addListener(details => {
  ...
  if (reason === "install") {
    ...
    text =
      "Thank you for installing ProKeys! Please reload all active tabs for changes to take effect.";
