this.switchToTextarea = function(transferContentsToShownEditor) {
	...
	if (transferContentsToShownEditor) this.setPlainText(this.getRichText());
};
...
this.switchToRichEditor = function(transferContentsToShownEditor) {
	...
	if (transferContentsToShownEditor) this.setRichText(pk.convertBetweenHTMLTags(this.getPlainText(), true));
};
