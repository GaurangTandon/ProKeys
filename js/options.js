...
/* global chrome, saveSnippetData */
/* global Folder, Snip, Generic */
...
(function () {
        ...
        function handleDuplicatesInSnippets(inputFolderMain, shouldMergeDuplicateFolderContents) {
            ...
            function both(object) {
                ...
                if (objectNameLen <= pk.OBJECT_NAME_LIMIT - stringToAppendToImportedObject.length) {
                    ...
                    object.name = object.name.substring(0, objectNameLen - 3)
            ...
            function handleSingleObject(importedObj) {
                const duplicateObj = Data.snippets.getUniqueObject(
                        importedObj.name,
                        importedObj.type,
                    ),
                ...
                if (Folder.isFolder(importedObj)) {
                    ...
                    if (
                        duplicateObj
                        && !shouldKeepBothFolders
                        && shouldMergeDuplicateFolderContents
                    ) {
    ...
    function setupEditPanel(type) {
        ...
        function highlightInFolderList(folderElm, name) {
            ...
            for (let i = 0, len = folderNames.length; i < len; i++) {
    ...
    function commonValidation(panelName) {
        ...
        return function (callback) {
            ...
            if (isSnippet) {
                ...
                body = manipulateElmForValidation(
                    undefined,
                    Snip.isValidBody,
                    panel.q(".body .error"),
                );
...
<u>supports</u></i><b> HTML formatting</b>. You can use the "my_sign" sample snippet here, and see the effect.`,
            ...
            (function bulkActionsWork() {
                ...
                $bulkActionBtn.on("click", function () {
                    ...
                    if ($bulkActionPanel.hasClass(SHOW_CLASS)) {
                        ...
                        originalShownFolder = Data.snippets.getUniqueFolder(
                            originalShownFolderName,
                        );
        ...
        (function backUpWork() {
            ...
            function showDataForExport() {
                ...
                if (dataUse === "print") {
                    ...
                    dataToExport = JSON.stringify(
                        dataUse === "data" ? Data : Data.snippets,
                        undefined,
                        2,
                    );
                    Data.snippets = Folder.fromArray(Data.snippets);
            ...
            importPopup.on("paste", (event) => {
                ...
                importThroughClipboardSpan.html(
                    "Pasted data is ready. Click Restore button to begin.",
                );
            });
            ...
            $revisionsRestoreBtn.on("click", () => {
                try {
                    if (window.confirm("Are you sure you want to use the selected revision?")) {
                        ...
                        latestRevisionLabel = `restored revision (labelled: ${
